...
import com.knowledgespike.quotes.producer.PublishRegisterUserDlx;
...
public class UserController {
    ...
    public static Handler regsterUserDlx = ctx -> {
        try {
            var message = ctx.bodyAsClass(UserRegistrationMessage.class);

            var publishRegisterUser = new PublishRegisterUserDlx(Application.connection);
